...
class TelegramCallAcceptActivity : ComponentActivity() {
    private var mediaPlayer: MediaPlayer? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            FakeCallTheme {
                TelegramCallAcceptScreen(onDrop = { navigateTo(MainActivity::class.java) })
            }
        }
    }
    ...
    @Composable
    fun TelegramCallAcceptScreen(onDrop: () -> Unit) {
        ...
        Box(
            ...
            Row(
                ...
                TextButton(onClick = {onChangedSound()}) {
                    Image(
                        painter = painterResource(id = R.drawable.callaccepttelegramaudio),
                        contentDescription = null,
                ...
                TextButton(onClick = onDrop) {
                    Image(
                        painter = painterResource(id = R.drawable.callaccepttelegramcamera),
                        contentDescription = null,
                        modifier = Modifier.size(80.dp)
                    )
                }
                ...
                TextButton(onClick =  {onChangedSound()}) {
                    Image(
                        painter = painterResource(id = R.drawable.callaccepttelegrammicro),
                        contentDescription = null,
                        modifier = Modifier.size(80.dp)
                    )
                }
                ...
                TextButton(onClick = onDrop) {
                    Image(
                        painter = painterResource(id = R.drawable.calltelegramdrop),
                        contentDescription = null,
                        modifier = Modifier.size(80.dp)
                    )
                }
