...
class WhatsappDetailActivity : ComponentActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            FakeCallTheme {
                WhatsappDetailScreen(onMenuClick = {navigateTo(MainActivity::class.java)})
            }
        }
    }
}
...
@Composable
fun  WhatsappDetailScreen( onMenuClick : () -> Unit = {}, onCalling : () -> Unit = {}, onVideoCalling : () -> Unit = {}) {
    Image(
